export class validateBirthday {
    ...
    constructor(dayValidator, monthValidator, yearValidator, dateValidator, timeDifferenceCalculator) {
        if (!dayValidator || !monthValidator || !yearValidator || !dateValidator || !timeDifferenceCalculator) {
